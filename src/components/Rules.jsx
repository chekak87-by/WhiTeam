...
export default function Rules({ setActivePage, lang }){
  const t = translations[lang];

  // === МАССИВ С ПРАВИЛАМИ (ПЕРЕНЕСЕН ВНУТРЬ КОМПОНЕНТА) ===
  const RULES_DATA = [
    {
      id: '01',
      title: t.r_t1,
    ...
    <div className="w-full max-w-4xl mx-auto py-4 px-4 md:px-8 pb-16">
      ...
      <div className="mb-12 text-center md:text-left">
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
          {t.rulesTitle1} <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600">{t.rulesTitle2}</span>
        </h2>

...
export default function App() {
  ...
  const contactsList = [
    {
      id: 'telegram', title: 'Telegram', value: '@WhiTeam', href: 'https://t.me/WhiTeam',
              ...
              <div className={`w-full ${CONFIG.homeCard.mobile} ${CONFIG.homeCard.tablet} ${CONFIG.homeCard.laptop} ${CONFIG.homeCard.desktop} xl:col-start-7 xl:col-span-6 relative group`}>
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: syncDuration, delay: syncDelay + 0.3, ease: "easeOut" }} className="w-full h-full rounded-[2.5rem] border border-[#27272A] bg-[#0E0E11] flex flex-col p-8 xl:p-10 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_20px_40px_rgba(0,0,0,0.4)] group-hover:border-purple-500/40 xl:group-hover:-translate-y-2 group-hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_30px_60px_-10px_rgba(168,85,247,0.3)] transition-all duration-[190ms] ease-out z-10 transform-gpu">
                  <div className="w-full h-full flex flex-col justify-between opacity-30 group-hover:opacity-100 transition-opacity duration-[190ms]">
                    ...
                    <div className="flex gap-1.5 mt-auto pt-6">{[...Array(5)].map((_, i) => (<svg key={i} className="w-4 h-4 xl:w-5 xl:h-5 text-purple-500/50 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>))}</div>
                  </div>
                </motion.div>
              </div>
            </motion.main>
